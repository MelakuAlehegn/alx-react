...
describe("Notification tests", () => {
    it("Notifications renders Notification component without crashing", () => {
        const component = shallow(<Notifications />);

        expect(component).toBeDefined();
    });

    it("Notifications renders correct list items", () => {
    ...
    it("Notifications renders an unordered list", () => {
        const wrapper = shallow(<Notifications />);
        expect(wrapper.find("ul").children()).toHaveLength(3);
    ...
    it("Notifications renders correct text", () => {
        const component = shallow(<Notifications />);
